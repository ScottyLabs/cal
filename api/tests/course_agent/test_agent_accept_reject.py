def test_agent_accepts_site_and_calendar(
    ...
    mocker.patch("course_agent.app.agent.nodes.critic.llm", mock_llm)
    ...
    mocker.patch("course_agent.app.agent.nodes.critic.verify_course_website")

    mocker.patch("course_agent.app.agent.nodes.extract_calendar.upsert_calendar_source")
...
def test_agent_rejects_first_site_and_continues(
    ...
    state = {
        **ca_base_state,
        "candidate_urls": [
            "https://www.reddit.com/r/cmu/comments/p0t1q7/15112_or_15122/",
            "https://www.coursicle.com/cmu/courses/CS/15112/",
        ],
    }
