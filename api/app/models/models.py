...
class Course(Base):
    ...
    websites: Mapped[list["CourseWebsite"]] = relationship(
        "CourseWebsite", back_populates="course", cascade="all, delete-orphan"
    )
...
class CourseWebsite(Base):
    ...
    agent_run: Mapped["AgentRun"] = relationship(
        "AgentRun", back_populates="course_websites"
    )
...
class User(Base):
    ...
    synced_events: Mapped[List["SyncedEvent"]] = relationship(
        "SyncedEvent", back_populates="user"
    )
    user_saved_events: Mapped[List["UserSavedEvent"]] = relationship(
        "UserSavedEvent", back_populates="user"
    )
...
class Admin(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["categories.id"],
            ondelete="CASCADE",
            name="admins_category_id_fkey",
        ),
        ForeignKeyConstraint(
            ["org_id"],
            ["organizations.id"],
            ondelete="CASCADE",
            name="admins_org_id_fkey",
        ),
        ForeignKeyConstraint(
            ["user_id"], ["users.id"], ondelete="CASCADE", name="admins_user_id_fkey"
        ),
    ...
    category: Mapped[Optional["Category"]] = relationship(
        "Category", back_populates="admins"
    )
...
class Category(Base):
    ...
    event_occurrences: Mapped[List["EventOccurrence"]] = relationship(
        "EventOccurrence", back_populates="category"
    )
    calendar_sources: Mapped[List["CalendarSource"]] = relationship(
        "CalendarSource", back_populates="category"
    )
...
class CalendarSource(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            "category_id", "url", name="calendar_sources_category_url_key"
        ),
        ForeignKeyConstraint(
            ["category_id"],
            ["categories.id"],
            ondelete="CASCADE",
            name="calendar_sources_category_id_fkey",
        ),
        ForeignKeyConstraint(
            ["org_id"],
            ["organizations.id"],
            ondelete="CASCADE",
            name="calendar_sources_org_id_fkey",
        ),
    ...
    fetch_interval_seconds: Mapped[int] = mapped_column(
        BigInteger, server_default=text("'21600'::bigint")
    )
    deletion_policy: Mapped[str] = mapped_column(
        Text, server_default=text("'mirror'::text")
    )
    all_day_handling: Mapped[str] = mapped_column(
        Text, server_default=text("'date_only'::text")
    )
    horizon_days: Mapped[int] = mapped_column(
        BigInteger, server_default=text("'180'::bigint")
    )
    ...
    last_modified_hdr: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime(True)
    )
    ...
    category: Mapped["Category"] = relationship(
        "Category", back_populates="calendar_sources"
    )
    org: Mapped["Organization"] = relationship(
        "Organization", back_populates="calendar_sources"
    )
...
class Schedule(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["user_id"], ["users.id"], ondelete="CASCADE", name="schedules_user_id_fkey"
        ),
    ...
    schedule_orgs: Mapped[List["ScheduleOrg"]] = relationship(
        "ScheduleOrg", back_populates="schedule", cascade="all, delete-orphan"
    )
    user_saved_events: Mapped[List["UserSavedEvent"]] = relationship(
        "UserSavedEvent", back_populates="schedule", cascade="all, delete-orphan"
    )
...
class SyncedEvent(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["users.id"],
            onupdate="CASCADE",
            name="synced_events_user_id_fkey",
        ),
...
class Event(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["calendar_sources.id"],
            ondelete="SET NULL",
            name="events_calendar_source_id_fkey",
        ),
        ForeignKeyConstraint(
            ["category_id"],
            ["categories.id"],
        ...
        UniqueConstraint(
            "calendar_source_id", "ical_uid", name="events_unique_calendar_uid"
        ),
    )
    ...
    ical_last_modified: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime(True)
    )
    occurrences_valid_through: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime(True)
    )
    last_occurrence_build_at: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime(True)
    )

    calendar_source: Mapped[Optional["CalendarSource"]] = relationship(
        "CalendarSource", back_populates="events"
    )
    ...
    event_tags: Mapped[List["EventTag"]] = relationship(
        "EventTag", back_populates="event", passive_deletes=True
    )
    recurrence_rules: Mapped[List["RecurrenceRule"]] = relationship(
        "RecurrenceRule", back_populates="event", passive_deletes=True
    )
    user_saved_events: Mapped[List["UserSavedEvent"]] = relationship(
        "UserSavedEvent", back_populates="event", passive_deletes=True
    )
...
class ScheduleOrg(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["organizations.id"],
            ondelete="CASCADE",
            name="schedule_orgs_org_id_fkey",
        ),
        ForeignKeyConstraint(
            ["schedule_id"],
            ["schedules.id"],
            ondelete="CASCADE",
            name="schedule_orgs_schedule_id_fkey",
        ),
    ...
    org: Mapped["Organization"] = relationship(
        "Organization", back_populates="schedule_orgs"
    )
    schedule: Mapped["Schedule"] = relationship(
        "Schedule", back_populates="schedule_orgs"
    )
...
class EventOccurrence(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["categories.id"],
            ondelete="CASCADE",
            name="event_occurrences_category_id_fkey",
        ),
        ForeignKeyConstraint(
            ["event_id"],
            ["events.id"],
        ...
        ForeignKeyConstraint(
            ...
            ["organizations.id"],
            ondelete="CASCADE",
            name="event_occurrences_org_id_fkey",
        ),
    ...
    category: Mapped["Category"] = relationship(
        "Category", back_populates="event_occurrences"
    )
    event: Mapped["Event"] = relationship("Event", back_populates="event_occurrences")
    org: Mapped["Organization"] = relationship(
        "Organization", back_populates="event_occurrences"
    )
...
class EventTag(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["tag_id"], ["tags.id"], ondelete="CASCADE", name="event_tags_tag_id_fkey"
        ),
...
class RecurrenceRule(Base):
    ...
    frequency: Mapped[str] = mapped_column(
        Enum(FrequencyType, name="frequency_type", create_type=False)
    )
    ...
    orig_until: Mapped[Optional[datetime.date]] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
    last_generated_at: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime(timezone=True), nullable=True
    )

    event: Mapped["Event"] = relationship("Event", back_populates="recurrence_rules")
    event_overrides: Mapped[List["EventOverride"]] = relationship(
        "EventOverride", back_populates="rrule"
    )
    recurrence_exdates: Mapped[List["RecurrenceExdate"]] = relationship(
        "RecurrenceExdate", back_populates="rrule"
    )
    recurrence_rdates: Mapped[List["RecurrenceRdate"]] = relationship(
        "RecurrenceRdate", back_populates="rrule"
    )
    recurrence_overrides: Mapped[List["RecurrenceOverride"]] = relationship(
        "RecurrenceOverride", back_populates="rrule"
    )
...
class RecurrenceExdate(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["recurrence_rules.id"],
            ondelete="CASCADE",
            name="recurrence_exdates_rrule_id_fkey",
        ),
    ...
    rrule: Mapped["RecurrenceRule"] = relationship(
        "RecurrenceRule", back_populates="recurrence_exdates"
    )
...
class RecurrenceRdate(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["recurrence_rules.id"],
            ondelete="CASCADE",
            name="recurrence_rdates_rrule_id_fkey",
        ),
    ...
    rrule: Mapped["RecurrenceRule"] = relationship(
        "RecurrenceRule", back_populates="recurrence_rdates"
    )
...
class EventOverride(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["recurrence_rules.id"],
            ondelete="CASCADE",
            name="event_overrides_rrule_id_fkey",
        ),
    ...
    rrule: Mapped["RecurrenceRule"] = relationship(
        "RecurrenceRule", back_populates="event_overrides"
    )
...
class RecurrenceOverride(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["recurrence_rules.id"],
            ondelete="CASCADE",
            name="recurrence_overrides_rrule_id_fkey",
        ),
    ...
    by_day: Mapped[Optional[list]] = mapped_column(
        ARRAY(Text())
    )  # e.g., ['TU', 'TH'] for Tuesdays and Thursdays
    by_month: Mapped[Optional[int]] = mapped_column(
        SmallInteger
    )  # 1-12, e.g., 6 for June
    by_month_day: Mapped[Optional[int]] = mapped_column(
        SmallInteger
    ...
    rrule: Mapped["RecurrenceRule"] = relationship(
        "RecurrenceRule", back_populates="recurrence_overrides"
    )
...
class UserSavedEvent(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["events.id"],
            ondelete="CASCADE",
            name="user_saved_events_event_id_fkey",
        ),
        ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            ondelete="CASCADE",
            name="user_saved_events_user_id_fkey",
        ),
        ForeignKeyConstraint(
            ["schedule_id"],
            ["schedules.id"],
            ondelete="CASCADE",
            name="user_saved_events_schedule_id_fkey",
        ),
        PrimaryKeyConstraint("user_id", "event_id", name="user_saved_events_pkey"),
        UniqueConstraint(
            "google_event_id", name="user_saved_events_google_event_id_key"
        ),
    )
    ...
    schedule: Mapped[Optional["Schedule"]] = relationship(
        "Schedule", back_populates="user_saved_events"
    )
