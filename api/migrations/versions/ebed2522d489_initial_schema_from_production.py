...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name="schedules_user_id_fkey", ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name="admins_user_id_fkey", ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.BigInteger(),
            server_default=sa.text("'21600'::bigint"),
            nullable=False,
        ),
        sa.Column(
            "deletion_policy",
            sa.Text(),
            server_default=sa.text("'mirror'::text"),
            nullable=False,
        ),
        sa.Column(
            "all_day_handling",
            sa.Text(),
            server_default=sa.text("'date_only'::text"),
            nullable=False,
        ),
        sa.Column(
            "horizon_days",
            sa.BigInteger(),
            server_default=sa.text("'180'::bigint"),
            nullable=False,
        ),
        sa.Column(
            "sync_mode",
            sa.Text(),
            server_default=sa.text("'delta'::text"),
            nullable=False,
        ),
        sa.Column(
            "updated_at",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["course_id"],
            ["courses.id"],
            name="course_crosslist_course_id_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["group_id"],
            ["crosslist_groups.id"],
            name="course_crosslist_group_id_fkey",
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "occurrences_valid_through", sa.DateTime(timezone=True), nullable=True
        ),
        sa.Column(
            "last_occurrence_build_at", sa.DateTime(timezone=True), nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["category_id"],
            ["categories.id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["category_id"],
            ["categories.id"],
            name="schedule_categories_category_id_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["schedule_id"],
            ["schedules.id"],
            name="schedule_categories_schedule_id_fkey",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint(
            "schedule_id", "category_id", name="schedule_categories_pkey"
        ),
    )
    op.create_table(
        "schedule_orgs",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["calendar_source_id"],
            ["calendar_sources.id"],
            name="org_icals_calendar_source_id_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["category_id"],
            ["categories.id"],
            name="org_icals_category_id_fkey",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint(
            "category_id", "calendar_source_id", name="org_icals_pkey"
        ),
    )
    op.create_table(
        "clubs",
        sa.Column("event_id", sa.BigInteger(), nullable=False),
        sa.ForeignKeyConstraint(
            ["event_id"], ["events.id"], name="clubs_event_id_fkey", ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "recurrence",
            sa.Enum("ONETIME", "RECURRING", "EXCEPTION", name="recurrence_type"),
            nullable=False,
        ),
        sa.Column("description", sa.Text(), nullable=True),
        sa.Column("source_url", sa.Text(), nullable=True),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["tag_id"], ["tags.id"], name="event_tags_tag_id_fkey", ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "frequency",
            sa.Enum("DAILY", "WEEKLY", "MONTHLY", "YEARLY", name="frequency_type"),
            nullable=False,
        ),
